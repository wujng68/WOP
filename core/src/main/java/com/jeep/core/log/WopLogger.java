 ...
 * 功能描述：
 *
 * @日期：2013-12-30 17:15:28
 * @作者：wujng
 * @版本：1.0
 */
public class WopLogger implements Logger, Serializable {

    private static final long serialVersionUID = 1L;

    public WopLogger(Class clazz) {
    ...
    public static void setConfigLanguage(Locale configLanguage) {
        WopLogger.configLanguage = configLanguage;
    }
